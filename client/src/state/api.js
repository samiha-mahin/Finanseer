...
export const api = createApi({
  ...
  reducerPath: "main", //It tells Redux to keep all API data (like KPIs, products) under the key called "main" in the app’s state.
...
//providesTags: Tags the data returned by a query, tells RTK Query: “This data belongs to this tag.”  Think of it like this you’re saying “If something happens that changes ‘Kpis’ data, I’ll know I need to refetch or update this part of the cache.”
